...
class AssembledBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride, padding=0,
        ...
        self.weight1.to(self.device), self.weight2.to(self.device), self.weight3.to(self.device)
        ...
        if self.bias:
            ...
            self.bias1.to(self.device), self.bias2.to(self.device), self.bias3.to(self.device)
